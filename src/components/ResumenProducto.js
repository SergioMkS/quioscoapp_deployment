...
const ResumenProducto = ({producto}) => {
  ...
  return (
    <div className="flex items-center gap-10 p-5 mb-10 shadow">
        ...
        <div className="">
            <button
                className="flex w-full gap-2 px-5 py-2 mb-5 font-bold text-white uppercase rounded-md shadow-md bg-sky-600 hover:bg-sky-700"
                type="button"
            ...
            <button
                className="flex w-full gap-2 px-5 py-2 font-bold text-white uppercase rounded-md shadow-md bg-rose-600 hover:bg-rose-700"
                type="button"
